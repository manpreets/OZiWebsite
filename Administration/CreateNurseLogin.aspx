<%@ Page Title="Create Nurse Login" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="CreateNurseLogin.aspx.cs" Inherits="Administration_CreateNurseLogin" %>
...
<div id="CreateNurseLogin">
    <asp:CreateUserWizard ID="CreateUserWizard1" DisplayCancelButton="True" 
        CancelDestinationPageUrl="~/Administration/Default.aspx"  runat="server" 
        
       
        Width="589px" Height="388px">
                ...
                <ContentTemplate>
                    <table style="font-size:100%;height:388px;width:589px;color:#012987">
                        <tr>
                            ...
                            <h3>
                                Create New Nurse's Login Account</td>
                                </h3>
                        </tr>
                        <tr>
                            <td align="right">
                ...
                <ContentTemplate>
                    <table style="font-size:100%;height:388px;width:589px;">
                        ...
                        <tr>
                            <td>
                                 <h2>   
                                The new nurse account has been successfully created.
                                 </h2>
                            </td>
                        </tr>
                        <tr>
