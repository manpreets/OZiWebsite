<%@ Page Title="View Candidate Profile" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="ViewCandidateProfile.aspx.cs" Inherits="Administration_ViewCandidateProfile" %>
...
<h1>
    ...
    <br />
    <a href="ViewListCandidate.aspx" runat="server">View Candidates List</a>
</h1>
...
<table class="style1">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="TextBoxDateofBirth" runat="server" 
                AutoCompleteType="HomeStreetAddress"></asp:TextBox>
        </td>
        <td>
